          ...
          <tbody>
            <tr v-for="userName in users" :key="userName.id">
              <td v-if="canEdit == true">
                <v-text-field v-bind:disabled="!canEdit" class="text-field" v-model="userName.comment" />
              </td>
              ...
              <td>
                {{userName.date}}h
                <button class="edit-btn" v-on:click="editItem()" type="submit">EDIT</button>
                <button class="saveItem" v-on:click="saveItem(userName)">SAVE</button>
              </td>
            </tr>
          </tbody>
        </table>
